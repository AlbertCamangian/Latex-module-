...
1.  $\displaystyle\int (1-4x)^{1/2}\,dx$
    ...
    If we let $u=1-4x$, then $du=-4\,dx$. We multiply the integrand by $\frac{-4}{-4}$. Thus, $$\int (1-4x)^{1/2}\,dx = \int (1-4x)^{1/2}\;\cdot\;\frac{-4}{-4}\;dx = \int u^{1/2}\left(-\dfrac{du}{4}\right)\;dx =-\frac{1}{4} \int u^{1/2}\;du = -\frac{1}{4}\;\cdot\;\frac {2u^{3/2}}{3}\;+\;C.$$ We put the final answer in terms $x$ by substituting $u=1-4x$. Therefore, $$ \int (1-4x)^{1/2} \; dx= \frac {(1-4x)^{3/2}}{6}\;+\;C.$$
...
$$\displaystyle\lim_{x\to a}\frac{f(x)}{g(x)}=\lim_{x\to a}\frac{f'(x)}{g'(x)}$$ provided $\displaystyle\lim_{x \to a}\frac{f'(x)}{g'(x)}$ exists or $\displaystyle\lim_{x \to a}\frac{f'(x)}{g'(x)}=\pm\infty$
:::
...
We therefore need to employ other techniques. In particular, notice that for any $x> 0$, the following hold: $$\begin{aligned}
...
\center $\displaystyle\lim_{x\to a}f(x)=0$ and $\displaystyle\lim_{x\to a}g(x)=+\infty$ or $-\infty$, or \center $\displaystyle\lim_{x\to a}f(x)=+\infty$ or $-\infty$ and $\displaystyle\lim_{x \to a}g(x)=0.$

2.  The $\displaystyle\lim_{x \to a}f(x)+g(x)$ is an indeterminate form of type $\infty-\infty$ if either

\center $\displaystyle\lim_{x \to a}f(x)=+\infty$ and $\displaystyle\lim_{x \to a}g(x)=-\infty$, or \center $\displaystyle\lim_{x\to a}f(x)=-\infty$ and $\displaystyle\lim_{x\to a}g(x)=+\infty.$
:::
...
3.  $\displaystyle\lim_{x \to 1^+}\left(\dfrac{x}{x-1}-\frac{1}{\ln x}\right)\;\;\;\;\;\;\;\;\;\;\;\;\;\;\left(\dfrac{1}{0^+}-\frac{1}{0^+}\right)$
    ...
    **Solution.** $$\begin{aligned}\displaystyle\lim_{x \to 1^+}\left(\dfrac{x}{x-1}-\frac{1}{\ln x}\right)
